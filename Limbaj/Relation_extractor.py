...
#     ["pacient", "Paralizia", "compresiunii", "intracraniene",
#      "sanguin cerebral", "craniu", "cerebral", "Răspunsul"],
#     ["tensiune", "artere", "criteriu", "trunchi", "vasculare",
#      "vase", "trunchiul cerebral "], "E:\manual"))

# print(extract_relations(
#     ["Caine", "Pisica", "Mixer", "Vietuitoare"],
