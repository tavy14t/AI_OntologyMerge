...
#prop=get_propozitii("Fluxul sanguin cerebral este asigurat prin cele două artere carotide interne şi de cele două artere vertebrale care se unesc în trunchiul vertebrobazilar. Ramificaţiile intracraniene ale acestor artere sunt de tip terminal ceea ce conferă o gravitate crescută ocluziilor vasculare cerebrale. În plus celula nervoasă are o sensibilitate deosebită la hipoxie (moarte celulară în 3-5 minute de la oprirea circulaţiei). Hipoperfuzia este de asemeni urmată de consecinţe.")
...
def part_of_relation(term1,term2,prop):
    ...
    filter_1=["este ","numește","descrie","sunt","descriu","numesc","inclus"," incluse ","aparține", "face parte", "aparțin", "fac parte"]
