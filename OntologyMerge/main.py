...
# ----------------------- Translation ------------------------
ont_path_1 = ont_path_1 if ont_lang_1 == 'ro' else \
    utils.get_translated_ontology(ont_path_1)
ont_path_2 = ont_path_2 if ont_lang_2 == 'ro' else \
    utils.get_translated_ontology(ont_path_2)
# ------------------------------------------------------------
...
# -------------------- Conceptualization ---------------------
ont_path_result = utils.get_merged_ontology_path(
    ont_path_1, ont_path_2, relations)
# ------------------------------------------------------------
